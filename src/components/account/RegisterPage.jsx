          ...
          <AvForm onValidSubmit={this.handleValidSubmit}>
            ...
            <AvGroup>
              ...
              <AvInput
                ...
                onChange={this.handleInputChange}
                onKeyPress={this.handleKeyPress}
                placeholder="+14156987680"
                required
                type="tel"
                value={this.state.phone}
              />
              <AvFeedback>A phone number is required to register</AvFeedback>
              <span>
                Please include the country code (ie +1), without spaces between numbers
              </span>
            </AvGroup>
